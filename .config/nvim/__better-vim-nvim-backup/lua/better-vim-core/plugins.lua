...
local default_plugins = {
  ...
  helpers.should_load_theme("rose-pine", { "rose-pine/neovim" }),
  helpers.should_load_theme("nightfox", { "EdenEast/nightfox.nvim" }),
  "mattn/emmet-vim",
  {
  ...
  helpers.unloadable_by_key("comfortable-motion", "yuttie/comfortable-motion.vim"),
  {
